    ...
    if checkpoint_path and os.path.isfile(checkpoint_path):
        ...
        logging.info(
            "Loaded {} from checkpoint '{}'".format(
                state_dict_key or "weights", checkpoint_path
            )
        )
    else:
...
def load_pretrained(
    model, default_cfg, num_classes=1000, in_chans=3, filter_fn=None, strict=True
):
    ...
    state_dict = model_zoo.load_url(default_cfg["url"], map_location="cpu")
