...
model_map = dict(
    ...
    dpn68=_attrib(paper_model_name="DPN-68", paper_arxiv_id="1707.01629"),
    dpn68b=_attrib(paper_model_name="DPN-68b", paper_arxiv_id="1707.01629"),
    dpn92=_attrib(paper_model_name="DPN-92", paper_arxiv_id="1707.01629"),
    dpn98=_attrib(paper_model_name="DPN-98", paper_arxiv_id="1707.01629"),
    dpn107=_attrib(paper_model_name="DPN-107", paper_arxiv_id="1707.01629"),
    dpn131=_attrib(paper_model_name="DPN-131", paper_arxiv_id="1707.01629"),
    ...
    fbnetc_100=_attrib(paper_model_name="FBNet-C", paper_arxiv_id="1812.03443"),
    ...
    gluon_senet154=_attrib(paper_model_name="SENet-154", paper_arxiv_id="1812.01187"),
    ...
    gluon_xception65=_attrib(
        paper_model_name="Modified Aligned Xception",
    ...
    ig_resnext101_32x32d=_attrib(
        paper_model_name="ResNeXt-101 32×32d",
    ...
    inception_v4=_attrib(paper_model_name="Inception V4", paper_arxiv_id="1602.07261"),
    mixnet_l=_attrib(paper_model_name="MixNet-L", paper_arxiv_id="1907.09595"),
    mixnet_m=_attrib(paper_model_name="MixNet-M", paper_arxiv_id="1907.09595"),
    mixnet_s=_attrib(paper_model_name="MixNet-S", paper_arxiv_id="1907.09595"),
    mnasnet_100=_attrib(paper_model_name="MnasNet-B1", paper_arxiv_id="1807.11626"),
    mobilenetv3_100=_attrib(
        paper_model_name="MobileNet V3(1.0)", paper_arxiv_id="1905.02244"
    ),
    nasnetalarge=_attrib(
        paper_model_name="NASNet-A Large",
        paper_arxiv_id="1707.07012",
        batch_size=BATCH_SIZE // 4,
    ),
    pnasnet5large=_attrib(
        paper_model_name="PNASNet-5",
        paper_arxiv_id="1712.00559",
        batch_size=BATCH_SIZE // 4,
    ),
    resnet18=_attrib(paper_model_name="ResNet-18", paper_arxiv_id="1812.01187"),
    resnet26=_attrib(paper_model_name="ResNet-26", paper_arxiv_id="1812.01187"),
    resnet26d=_attrib(paper_model_name="ResNet-26-D", paper_arxiv_id="1812.01187"),
    resnet34=_attrib(paper_model_name="ResNet-34", paper_arxiv_id="1812.01187"),
    resnet50=_attrib(paper_model_name="ResNet-50", paper_arxiv_id="1812.01187"),
    ...
    semnasnet_100=_attrib(paper_model_name="MnasNet-A1", paper_arxiv_id="1807.11626"),
    senet154=_attrib(paper_model_name="SENet-154", paper_arxiv_id="1709.01507"),
    seresnet18=_attrib(paper_model_name="SE-ResNet-18", paper_arxiv_id="1709.01507"),
    seresnet34=_attrib(paper_model_name="SE-ResNet-34", paper_arxiv_id="1709.01507"),
    seresnet50=_attrib(paper_model_name="SE-ResNet-50", paper_arxiv_id="1709.01507"),
    seresnet101=_attrib(paper_model_name="SE-ResNet-101", paper_arxiv_id="1709.01507"),
    seresnet152=_attrib(paper_model_name="SE-ResNet-152", paper_arxiv_id="1709.01507"),
    ...
    tf_mixnet_l=_attrib(paper_model_name="MixNet-L", paper_arxiv_id="1907.09595"),
    tf_mixnet_m=_attrib(paper_model_name="MixNet-M", paper_arxiv_id="1907.09595"),
    tf_mixnet_s=_attrib(paper_model_name="MixNet-S", paper_arxiv_id="1907.09595"),
